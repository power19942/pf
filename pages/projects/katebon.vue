      ...
      <b-container style="height: 100%" class="d-flex flex-column justify-content-center">
        <b-row>
          ...
          <b-col md="8" class="text-center">
            ...
            <h1 class="main-headline mb-5">Katebon Website</h1>
...
export default {
  ...
  data() {
    return {
      selectedImage: 0,
      images: [
        '/images/portfolio/katebon/1.webp',
        '/images/portfolio/katebon/2.webp',
        '/images/portfolio/katebon/3.webp',
        '/images/portfolio/katebon/4.webp'
      ]
    }
  },
  methods: {
