    ...
    <b-container style="height: 100%" class="d-flex flex-column justify-content-center">
      <b-row>
        ...
        <b-col md="8"  class="text-center">
          ...
          <h1 class="main-headline mb-5">Dribbble Clone</h1>
          <p class="description mb-5">
            This is a small Dribbble clone built while I'm learning vuejs and nuxt
...
name: "menhag",
  ...
  return {
    selectedImage:0,
    images:[
      '/images/portfolio/dribble/1.webp',
      '/images/portfolio/dribble/2.webp',
      '/images/portfolio/dribble/3.webp',
      '/images/portfolio/dribble/4.webp',
    ]
  }
  },
  methods:{
